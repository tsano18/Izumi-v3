...
module.exports = {
  ...
  OWNER_NAME: process.env.OWNER_NAME || "DANTINA",
  BOT_NAME: process.env.BOT_NAME || "DANTINA_WABOT",
  SUDO: process.env.SUDO || null,
  LANG: process.env.LANGUAGE === undefined ? 'EN' : process.env.LANGUAGE.toUpperCase(),
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || "DANTINA_ENT",
  AUDIO_DATA: process.env.AUDIO_DATA || "Eʏᴘᴢ;Iᴢᴜᴍɪ-ᴠ3;https://i.imgur.com/cO0TZJv.jpeg",
  PROCESSNAME: process.env.PROCESSNAME || "DANTINA",
  AUTHOR: process.env.AUTHOR || "DANTINA",
